...
1. **Adding Tasks**: Type in the text field and press Enter/Return. The task is validated and saved to Core Data.

2. **Editing Tasks**: Tap on any pending task to edit its text inline. Press Enter to save changes.

3. **Completing Tasks**: Tap the checkbox icon to toggle between pending and completed states.

4. **Data Persistence**: All changes are automatically saved to Core Data and persist between app launches.
...
[toha-gornich](https://github.com/toha-gornich)
